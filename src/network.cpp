...
namespace White {
QuantizedNetwork::QuantizedNetwork() // clang-format off
...
AlphaGomoku::GodNet::RetType QuantizedNetwork::feed(const Tensor<uint8_t, 3, 15, 15> &input) {
  ...
  // clang-format off
    ...
    // Reshape functional_1_1/flatten_3_1/Reshape: functional_1_1_conv2d_17_1_convolution_quant.output().flatten(); 
    // Reshape functional_1_1/flatten_2_1/Reshape: functional_1_1_conv2d_16_1_BiasAdd_quant.output().flatten(); 
...
AlphaGomoku::GodNet::RetType QuantizedNetwork::feed(const Tensor<uint8_t, 3, 15, 15> &input) {
  ...
  // clang-format off
    ...
    // Reshape functional_1/flatten_2/Reshape: functional_1_conv2d_7_1_BiasAdd_quant.output().flatten(); 
    // Reshape functional_1/flatten_1_1/Reshape: functional_1_conv2d_8_1_convolution_quant.output().flatten(); 
